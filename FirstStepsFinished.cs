...
//CUBE2_________________________________________________________________________
         ...
         _cube2Transform = new TransformComponent {Scale = new float3(3, 3, 1 ), Translation = new float3 (30, 0, 30), Rotation = new float3 (0.1f, 0.5f, 0)};
...
//CUBE3_______________________________________________________________________________
         _cube3Transform = new TransformComponent {Scale = new float3(1, 1, 1 ), Translation = new float3(15, 0, -10), Rotation = new float3 (-0.1f, -0.5f, 0)};
